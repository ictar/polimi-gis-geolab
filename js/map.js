...
// There MUST be a single reference publication
function refPub(ref_pub) {
  var popup = document.getElementById("myPopup");
  var pubname = document.getElementById(ref_pub);
  popup.innerHTML = pubname.innerHTML;
